			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="cidade" title="${message(code: 'organizacao.cidade.label', default: 'Cidade')}" />
				...
				<g:each in="${organizacaoInstanceList}" status="i" var="organizacaoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${organizacaoInstance.id}">${fieldValue(bean: organizacaoInstance, field: "cidade")}</g:link></td>
