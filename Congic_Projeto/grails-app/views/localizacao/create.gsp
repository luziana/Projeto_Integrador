		...
		<div id="create-localizacao" class="content scaffold-create panel panel-default" role="main">
		<div class="panel-heading">
		<a href="#create-localizacao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
