			...
			<div id="show-noticia" class="content scaffold-show" role="main">
				...
				<ol class="property-list noticia">
					...
					<g:if test="${noticiaInstance?.titulo}">
						<li class="fieldcontain"><span id="titulo-label"
							class="property-label"><g:message
									code="noticia.titulo.label" default="Titulo" /></span> <span
							class="property-value" aria-labelledby="titulo-label"><g:fieldValue
									bean="${noticiaInstance}" field="titulo" /></span></li>
					</g:if>

					<g:if test="${noticiaInstance?.descricao}">
						<li class="fieldcontain"><span id="descricao-label"
							class="property-label"><g:message
									code="noticia.descricao.label" default="Descricao" /></span> <span
							class="property-value" aria-labelledby="descricao-label"><g:fieldValue
									bean="${noticiaInstance}" field="descricao" /></span></li>
					</g:if>
				...
				<g:form onsubmit="Form(this);return false" url="[resource:noticiaInstance, action:'delete']">
					<fieldset class="buttons">
						...
						<a href="#"
							onclick="carregarPagina('<g:createLink action="edit" id="${noticiaInstance.id}" />')">
