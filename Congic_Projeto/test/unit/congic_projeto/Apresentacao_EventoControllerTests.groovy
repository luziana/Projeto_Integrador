...
@TestFor(Apresentacao_EventoController)
@Mock(Apresentacao_Evento)
class Apresentacao_EventoControllerTests {
    ...
    void testSave() {
        ...
        assert Apresentacao_Evento.count() == 1
    }
    ...
    void testShow() {
        ...
        populateValidParams(params)
        def apresentacao_Evento = new Apresentacao_Evento(params)
    ...
    void testDelete() {
        ...
        assert Apresentacao_Evento.count() == 0
        assert Apresentacao_Evento.get(apresentacao_Evento.id) == null
        assert response.redirectedUrl == '/apresentacao_Evento/list'
    }
}
