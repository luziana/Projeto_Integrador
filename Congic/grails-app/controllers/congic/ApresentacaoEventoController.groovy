...
class ApresentacaoEventoController {
    ...
    def list(Integer max) {
        ...
        [apresentacaoInstanceList: ApresentacaoEvento.list(params), apresentacaoInstanceTotal: ApresentacaoEvento.count()]
    }

    def create() {
        [apresentacaoInstance: new ApresentacaoEvento(params)]
    }

    def save() {
        def apresentacaoInstance = new ApresentacaoEvento(params)
    ...
    def show(Long id) {
        def apresentacaoInstance = ApresentacaoEvento.get(id)
	...
	def apresentacaoEvento(){
		def apresentacao = ApresentacaoEvento.list()
