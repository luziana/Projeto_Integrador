...
class Apresentacao_EventoController {
    ...
    def list(Integer max) {
        ...
        [apresentacaoInstanceList: Apresentacao_Evento.list(params), apresentacaoInstanceTotal: Apresentacao_Evento.count()]
    }

    def create() {
        [apresentacaoInstance: new Apresentacao_Evento(params)]
    }

    def save() {
        def apresentacaoInstance = new Apresentacao_Evento(params)
    ...
    def show(Long id) {
        def apresentacaoInstance = Apresentacao_Evento.get(id)
