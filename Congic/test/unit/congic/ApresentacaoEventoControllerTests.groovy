...
@TestFor(ApresentacaoEventoController)
@Mock(ApresentacaoEvento)
class ApresentacaoEventoControllerTests {
    ...
    void testSave() {
        ...
        assert ApresentacaoEvento.count() == 1
    }
    ...
    void testShow() {
        ...
        populateValidParams(params)
        def apresentacao = new ApresentacaoEvento(params)
    ...
    void testDelete() {
        ...
        assert ApresentacaoEvento.count() == 0
        assert ApresentacaoEvento.get(apresentacao.id) == null
        assert response.redirectedUrl == '/apresentacao/list'
    }
}
